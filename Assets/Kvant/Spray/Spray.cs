...
namespace Kvant {
    ...
    public partial class Spray : MonoBehaviour {
        ...
        [SerializeField] float _life = 4;
        [SerializeField, Range(0, 1)] float _lifeRandomness = 0.6f;
        [SerializeField] Vector3 _initialVelocity = Vector3.forward * 4;
        [SerializeField, Range(0, 1)] float _directionSpread = 0.2f;
        ...
        [SerializeField] float _spin = 20;
        [SerializeField] float _speedToSpin = 60;
        ...
        [SerializeField] float _noiseMotion = 1;
        ...
        public int maxParticles => (_bulkMesh==null || _bulkMesh.copyCount<1)
            ? 0 : (_maxParticles/_bulkMesh.copyCount+1) * _bulkMesh.copyCount;
        ...
        public Material material {
            get { if (!_owningMaterial) {
                _material = Instantiate<Material>(_material);
                _owningMaterial = true; } return _material; }
            set { if (_owningMaterial) Destroy(_material, 0.1f);
                _material = value; _owningMaterial = false; } }
        ...
        static float deltaTime =>
            !Application.isPlaying || Time.frameCount<2 ? 0.1f : Time.deltaTime;

        public void NotifyConfigChange() => _needsReset = true;
        ...
        void UpdateKernelShader() {
            ...
            var invLifeMax = 1f / Mathf.Max(_life, 0.01f);
            ...
            else _noiseOffset += _acceleration.normalized * _noiseMotion * deltaTime;
        ...
        void ResetResources() {
            if (_bulkMesh == null) _bulkMesh = new BulkMesh(_shapes);
            else _bulkMesh.Rebuild(_shapes);
            ...
            InitializeAndPrewarmBuffers(); // Warming up
            _needsReset = false;
        }
        ...
        void InitializeAndPrewarmBuffers() {
            ...
            for (var i=0; i<8; ++i) { SwapBuffersAndInvokeKernels(); UpdateKernelShader(); }
        }
        ...
        void SwapBuffersAndInvokeKernels() {
            ...
            // invoke the velocity and rotation update kernel with updated position
        ...
        void Update() {
            ...
            } else InitializeAndPrewarmBuffers();
            ...
            for (var i=0; i<_positionBuffer2.height; ++i) {
                ...
                Graphics.DrawMesh(
                    mesh, position, rotation, material, 0, null, 0,
                    props, _castShadows, _receiveShadows);
            }
        }
